...
var file_hello_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x22, 0x27, 0x0a, 0x0b, 0x48, 0x65,
	...
	,
...
var file_hello_proto_goTypes = []interface{}{
	...
	(*HelloReplay)(nil),  // 1: hello.HelloReplay
	(*HelloMessage)(nil), // 2: hello.HelloMessage
}
var file_hello_proto_depIdxs = []int32{
	0, // 0: hello.HelloServer.SayHi:input_type -> hello.HelloRequest
	0, // 1: hello.HelloServer.GetMsg:input_type -> hello.HelloRequest
	1, // 2: hello.HelloServer.SayHi:output_type -> hello.HelloReplay
	2, // 3: hello.HelloServer.GetMsg:output_type -> hello.HelloMessage
...
func (c *helloServerClient) SayHi(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReplay, error) {
	out := new(HelloReplay)
	err := c.cc.Invoke(ctx, "/hello.HelloServer/SayHi", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloServerClient) GetMsg(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloMessage, error) {
	...
	err := c.cc.Invoke(ctx, "/hello.HelloServer/GetMsg", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HelloServer_SayHi_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hello.HelloServer/SayHi",
	}
...
func _HelloServer_GetMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hello.HelloServer/GetMsg",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
